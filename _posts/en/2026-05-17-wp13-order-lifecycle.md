...
description: "WP13 guide: An order status is a transaction boundary, not a loose enum."
lang: en
...
---
# Whitepaper Guide: Order Lifecycle State Machine
...
WP13 is different. It should be read as a control design for search & trade: where the system draws boundaries, which facts must be preserved, how failure is classified, and what evidence proves the capability works.
...
The question behind this asset is not "does HotelByte have Order Lifecycle State Machine?" The better question is:
...
HotelByte treats Order Lifecycle State Machine as part of a broader governed platform, not as an isolated implementation detail. The architecture is expected to leave a trail: normalized contracts, explicit ownership, testable behavior, and production evidence that can be inspected after the fact.
...
- [Full English whitepaper](/en/whitepapers/wp13-order-lifecycle/original/)
- [Chinese version](/zh/whitepapers/wp13-order-lifecycle/original/)
